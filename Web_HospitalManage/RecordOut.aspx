<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecordOut.aspx.cs" Inherits="RecordOut" %>
...
<head id="Head1" runat="server">
    ...
    //弹出子窗体
    function showUrl(id) {
        window.showModalDialog('RecordUpdate.aspx?id='+id, window, 'dialogWidth=400px;dialogHeight=400px;')
...
border="0">
    <tr>
      <td class="bg_tr" style="height:25px; line-height:25px;"><span style="float:left; padding-left:2px;">办理出院</span><span style="float:right;"></span></td>   
    </tr>
    <tr>
...
border="0">
  <tbody>
    ...
    <td align="center" class="td_bg" height="23"><%#Eval("P_No")%></td>
       ...
       <td align="center" class="td_bg" height="23"><a href='#' onclick='showUrl("<%#Eval("R_Id")%>")'>办理</a></td>
        <td align="center" class="td_bg" height="23"><a href='PatientProjectManage.aspx'>缴费</a></td>
    </tr>
  </tbody>
