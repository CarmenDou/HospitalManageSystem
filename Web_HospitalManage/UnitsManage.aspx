<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnitsManage.aspx.cs" Inherits="UnitsManage" %>
...
border="0">
    <tr>
      <td class="bg_tr" style="height:25px; line-height:25px;"><span style="float:left; padding-left:2px;">计量单位管理</span><span style="float:right;"><input id="Button1"
              type="button" value="添加" onclick="window.location.replace('UnitsAdd.aspx');" /></span></td>   
    </tr>
...
border="0">
    ...
    <tr>
       ...
       <td style="font-weight:bold" align="center" class="td_bg"  height="23">选择</td>
        ...
        <td style="font-weight:bold"  align="center" class="td_bg"  height="23">计量名称</td>
    ...
    <tr>
       ...
       <td align="center" class="td_bg" height="23"><a href='UnitsAdd.aspx?id=<%#Eval("U_Id")%>'>修改</a></td>
    </tr>
