<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RolesManage.aspx.cs" Inherits="RolesManage" %>
...
border="0">
    <tr>
      <td class="bg_tr" style="height:25px; line-height:25px;"><span style="float:left; padding-left:2px;">角色管理</span><span style="float:right;"><input id="Button1"
              type="button" value="添加" onclick="window.location.replace('RolesAdd.aspx');" /></span></td>   
    </tr>
...
border="0">
    ...
    <tr>
       ...
       <td align="center" class="td_bg" height="23"><a href='RolesAdd.aspx?id=<%#Eval("R_Id")%>'>修改</a></td>
    </tr>
