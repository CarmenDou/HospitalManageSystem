...
public partial class DrugTypeManage : System.Web.UI.Page
{
    ...
    public string strUrlPage = "DrugTypeManage.aspx";//跳转的页
    ...
    private void Binds()
    {
        ...
        count = DrugTypeBLL.CountNumber(strWhere);
        FenYe();
        RpView.DataSource = DrugTypeBLL.PageSelectDrugType(pageSize, currentPageIndex, strWhere, "Dt_Id", "asc");
        RpView.DataBind();
    ...
    protected void BtnAllDel_Click(object sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
        {
            try
            {
                ...
                {
                    j++;
                    DrugTypeBLL.DeleteDrugType(Convert.ToInt32(c));
                }
