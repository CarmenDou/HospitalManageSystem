<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CostTypeManage.aspx.cs" Inherits="CostTypeManage" %>
...
border="0">
    <tr>
      <td class="bg_tr" style="height:25px; line-height:25px;"><span style="float:left; padding-left:2px;">费用分类管理</span><span style="float:right;"><input id="Button1"
              type="button" value="添加" onclick="window.location.replace('CostTypeAdd.aspx');" /></span></td>   
    </tr>
...
border="0">
    ...
    <tr>
       ...
       <td style="font-weight:bold" align="center" class="td_bg"  height="23">选择</td>
        ...
        <td style="font-weight:bold"  align="center" class="td_bg"  height="23">费用名称</td>
    ...
    <tr>
       ...
       <td align="center" class="td_bg" height="23"><input type="checkbox" value='<%#Eval("Ct_Id") %>' name="CheckMes" /></td>
        <td align="center" class="td_bg" height="23"><%#Container.ItemIndex + 1 + (currentPageIndex - 1) *  pageSize%></td>
       
        <td align="center" class="td_bg" height="23"><%#Eval("Ct_Name")%></td>
       <td align="center" class="td_bg" height="23"><a href='CostTypeAdd.aspx?id=<%#Eval("Ct_Id")%>'>修改</a></td>
    </tr>
