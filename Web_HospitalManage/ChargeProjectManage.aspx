<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChargeProjectManage.aspx.cs" Inherits="ChargeProjectManage" %>
...
border="0">
    <tr>
      <td class="bg_tr" style="height:25px; line-height:25px;"><span style="float:left; padding-left:2px;">门诊收费项目</span><span style="float:right;"><input id="Button1"
              type="button" value="添加" onclick="window.location.replace('ChargeProjectAdd.aspx');" /></span></td>   
    </tr>
    <tr>
      <td  align="center"  class="td_bg">
      项目编号：<asp:TextBox ID="txtNo" runat="server" ></asp:TextBox>&nbsp;项目名称：<asp:TextBox ID="txtName" runat="server" ></asp:TextBox>&nbsp;<asp:Button ID="btnSearch"
  ...
  <tbody>
    ...
    <tr>
       ...
       <td style="font-weight:bold" align="center" class="td_bg"  height="23">选择</td>
        ...
        <td style="font-weight:bold"  align="center" class="td_bg"  height="23">项目编号</td>
        <td style="font-weight:bold"  align="center" class="td_bg"  height="23">项目名称</td>
         <td style="font-weight:bold"  align="center" class="td_bg"  height="23">费用</td>
             <td style="font-weight:bold"  align="center" class="td_bg"  height="23">费用分类</td>
    ...
    <tr>
       ...
       <td align="center" class="td_bg" height="23"><input type="checkbox" value='<%#Eval("Cp_Id") %>' name="CheckMes" /></td>
        <td align="center" class="td_bg" height="23"><%#Container.ItemIndex + 1 + (currentPageIndex - 1) * pageSize%></td>
       
        <td align="center" class="td_bg" height="23"><%#Eval("Cp_No")%></td>
     <td align="center" class="td_bg" height="23"><%#Eval("Cp_Name")%></td>
                   <td align="center" class="td_bg" height="23"><%#Eval("Cp_Cost")%></td>
             <td align="center" class="td_bg" height="23"><%#BLL.CostTypeBLL.GetIdByCostType(Convert.ToInt32(Eval("Ct_Id"))).Ct_Name%></td>
       <td align="center" class="td_bg" height="23"><a href='ChargeProjectAdd.aspx?id=<%#Eval("Cp_Id")%>'>修改</a></td>
    </tr>
  </tbody>
