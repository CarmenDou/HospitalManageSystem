<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnitsAdd.aspx.cs" Inherits="UnitsAdd" %>
...
border="0">
  <tbody>
    <tr>
      ...
      <span style="color:Red;">*</span>计量名称
      </td>
         ...
         <asp:Button ID="btnAdd" 
            runat="server" Text="添加" OnClientClick="return check()" 
              onclick="btnAdd_Click"   /> &nbsp;&nbsp;<input  type="button"
                value="返回" onclick="window.location.replace('UnitsManage.aspx');" />
      </td>
    </tr>
    </tbody>
    </table>
