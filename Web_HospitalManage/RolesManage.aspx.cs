...
public partial class RolesManage : System.Web.UI.Page
{
    ...
    public string strUrlPage = "RolesManage.aspx";//跳转的页
    ...
    private void Binds()
    {
        ...
        count = RolesBLL.CountNumber(strWhere);
        FenYe();
        RpView.DataSource = RolesBLL.PageSelectRoles(pageSize, currentPageIndex, strWhere, "R_Id","asc");
        RpView.DataBind();
    ...
    protected void BtnAllDel_Click(object sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
        {
            try
            {
                ...
                {
                    j++;
                    RolesBLL.DeleteRoles(Convert.ToInt32(c));
                }
