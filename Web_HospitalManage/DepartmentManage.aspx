...
border="0">
    <tr>
      <td class="bg_tr" style="height:25px; line-height:25px;"><span style="float:left; padding-left:2px;">科室管理</span><span style="float:right;"><input id="Button1"
              type="button" value="添加" onclick="window.location.replace('DepartmentAdd.aspx');" /></span></td>   
    </tr>
...
border="0">
    ...
    <tr>
       ...
       <td align="center" class="td_bg" height="23"><a href='DepartmentAdd.aspx?id=<%#Eval("D_Id")%>'>修改</a></td>
    </tr>
