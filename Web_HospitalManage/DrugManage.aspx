<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DrugManage.aspx.cs" Inherits="DrugManage" %>
...
border="0">
    <tr>
      <td class="bg_tr" style="height:25px; line-height:25px;"><span style="float:left; padding-left:2px;">药品编辑 </span><span style="float:right;"><input id="Button1"
              type="button" value="添加" onclick="window.location.replace('DrugAdd.aspx');" /></span></td>   
    </tr>
    <tr>
...
border="0">
  <tbody>
    ...
    <tr>
       ...
       <td align="center" class="td_bg" height="23"><a href='DrugAdd.aspx?id=<%#Eval("D_Id")%>'>修改</a></td>
    </tr>
  </tbody>
