...
public partial class RecordManage : System.Web.UI.Page
{
    ...
    public string strUrlPage = "DiagnosisManage.aspx";//跳转的页
    ...
    private void Binds()
    {
        ...
        count = DiagnosisBLL.CountNumber2(strWhere);
        FenYe();
        RpView.DataSource = DiagnosisBLL.PageSelectDiagnosis2(pageSize, currentPageIndex, strWhere, "D_Time", "desc");
        RpView.DataBind();
    ...
    protected void BtnAllDel_Click(object sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
        {
            try
            {
                ...
                {
                    j++;
                    DiagnosisBLL.DeleteDiagnosis(Convert.ToInt32(c));
                }
