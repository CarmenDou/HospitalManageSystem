...
public partial class PatientManage : System.Web.UI.Page
{
    ...
    public string strUrlPage = "PatientManage.aspx";//跳转的页
    ...
    private void Binds()
    {
        ...
        count = PatientBLL.CountNumber(strWhere);
        FenYe();
        RpView.DataSource = PatientBLL.PageSelectPatient(pageSize, currentPageIndex, strWhere, "P_Id", "desc");
        RpView.DataBind();
    ...
    protected void BtnAllDel_Click(object sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
        {
            try
            {
                ...
                {
                    j++;
                    PatientBLL.DeletePatient(Convert.ToInt32(c));
                }
