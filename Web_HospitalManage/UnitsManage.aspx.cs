...
public partial class UnitsManage : System.Web.UI.Page
{
    ...
    public string strUrlPage = "UnitsManage.aspx";//跳转的页
    ...
    private void Binds()
    {
        ...
        count = UnitsBLL.CountNumber(strWhere);
        FenYe();
        RpView.DataSource = UnitsBLL.PageSelectUnits(pageSize, currentPageIndex, strWhere, "U_Id", "asc");
        RpView.DataBind();
    ...
    protected void BtnAllDel_Click(object sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
        {
            try
            {
                ...
                {
                    j++;
                    UnitsBLL.DeleteUnits(Convert.ToInt32(c));
                }
