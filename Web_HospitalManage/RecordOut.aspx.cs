...
public partial class RecordOut : System.Web.UI.Page
{
    ...
    public string strUrlPage = "RecordOut.aspx";//跳转的页
    ...
    private void Binds()
    {
        ...
        if (txtName.Text.Length != 0)
        {
            ...
            strWhere += " and R_State='入住中'";
        
        count = RecordBLL.CountNumber2(strWhere);
        FenYe();
        RpView.DataSource = RecordBLL.PageSelectRecord2(pageSize, currentPageIndex, strWhere, "R_Enter", "desc");
        RpView.DataBind();
    ...
    protected void BtnAllDel_Click(object sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
        {
            try
            {
                ...
                {
                    j++;
                    RecordBLL.DeleteRecord(Convert.ToInt32(c));
                }
