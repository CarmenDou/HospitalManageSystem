...
public partial class RegisterTypeManage : System.Web.UI.Page
{
    ...
    public string strUrlPage = "RegisterTypeManage.aspx";//跳转的页
    ...
    private void Binds()
    {
        ...
        count = RegisterTypeBLL.CountNumber(strWhere);
        FenYe();
        RpView.DataSource = RegisterTypeBLL.PageSelectRegisterType(pageSize, currentPageIndex, strWhere, "Rt_Id", "asc");
        RpView.DataBind();
    ...
    protected void BtnAllDel_Click(object sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
        {
            try
            {
                ...
                {
                    j++;
                    RegisterTypeBLL.DeleteRegisterType(Convert.ToInt32(c));
                }
