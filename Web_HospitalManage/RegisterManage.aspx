<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterManage.aspx.cs" Inherits="RegisterManage" %>
...
border="0">
    <tr>
      <td class="bg_tr" style="height:25px; line-height:25px;"><span style="float:left; padding-left:2px;">挂号查询</span><span style="float:right;"></td>   
    </tr>
    <tr>
      <td  align="center"  class="td_bg">
      挂号编号：<asp:TextBox ID="txtR_No" runat="server" ></asp:TextBox>&nbsp;姓名：<asp:TextBox ID="txtR_Name" runat="server" ></asp:TextBox>&nbsp;操作人：<asp:TextBox ID="txtKey" runat="server" ToolTip="职工号，姓名" ></asp:TextBox>&nbsp;<asp:Button ID="btnSearch"
  ...
  <tbody>
    ...
    <tr>
       ...
       <td style="font-weight:bold" align="center" class="td_bg"  height="23">选择</td>
        ...
        <td style="font-weight:bold"  align="center" class="td_bg"  height="23">挂号编号</td>
        <td style="font-weight:bold"  align="center" class="td_bg"  height="23">姓名</td>
        
         <td style="font-weight:bold"  align="center" class="td_bg"  height="23">挂号类型</td>
          <td style="font-weight:bold"  align="center" class="td_bg"  height="23">科室名称</td>
            <td style="font-weight:bold"  align="center" class="td_bg"  height="23">挂号费用</td>
    ...
    <tr>
       ...
       <td align="center" class="td_bg" height="23"><%#Eval("R_Name")%></td>
        <td align="center" class="td_bg" height="23"><%#BLL.RegisterTypeBLL.GetIdByRegisterType(Convert.ToInt32(Eval("Rt_Id"))).Rt_Name%></td>
       <td align="center" class="td_bg" height="23"><%#BLL.DepartmentBLL.GetIdByDepartment(Convert.ToInt32(Eval("D_Id"))).D_Name%></td>
       <td align="center" class="td_bg" height="23"><%#Eval("R_Cost")%></td>
             <td align="center" class="td_bg" height="23"><%#(Eval("U_No"))%>(<%#(Eval("U_Name"))%>)</td>
 <td align="center" class="td_bg" height="23"><a href='RegisterAdd.aspx?id=<%#Eval("R_Id")%>'>修改</a></td>
    </tr>
  </tbody>
