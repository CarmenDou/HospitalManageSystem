<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CalculateManage.aspx.cs" Inherits="CalculateManage" %>
...
border="0">
    <tr>
      ...
      <td class="bg_tr" style="height:25px; line-height:25px;"><span style="float:left; padding-left:2px;">处方查询</span><span style="float:right;"></span></td>   
    </tr>
    <tr>
  ...
  <tbody>
    ...
    <tr>
       ...
       <td style="font-weight:bold" align="center" class="td_bg"  height="23">选择</td>
        ...
        <td style="font-weight:bold"  align="center" class="td_bg"  height="23">划价编号</td>
        <td style="font-weight:bold"  align="center" class="td_bg"  height="23">病人编号</td>
                        <td style="font-weight:bold"  align="center" class="td_bg"  height="23">姓名</td>
                                <td style="font-weight:bold"  align="center" class="td_bg"  height="23">药品</td>
                <td style="font-weight:bold"  align="center" class="td_bg"  height="23">划价金额</td>
                <td style="font-weight:bold"  align="center" class="td_bg"  height="23">划价时间</td>
    ...
    <tr>
       ...
       <td align="center" class="td_bg" height="23"><input type="checkbox" value='<%#Eval("C_Id") %>' name="CheckMes" /></td>
        <td align="center" class="td_bg" height="23"><%#Container.ItemIndex + 1 + (currentPageIndex - 1) * pageSize%></td>
               <td align="center" class="td_bg" height="23"><%#Eval("C_No")%></td>
    <td align="center" class="td_bg" height="23"><%#Eval("P_No")%></td>
        <td align="center" class="td_bg" height="23"><%#Eval("P_Name")%></td>

           <td align="center" class="td_bg" height="23"><%#GetDrug(Eval("C_Id"))%></td>
              <td align="center" class="td_bg" height="23"><%#Eval("C_Amount")%></td>
       <td align="center" class="td_bg" height="23"><%#Convert.ToDateTime(Eval("C_Time")).ToString("yyyy-MM-dd HH:mm")%></td>
