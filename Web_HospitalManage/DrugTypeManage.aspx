<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DrugTypeManage.aspx.cs" Inherits="DrugTypeManage" %>
...
border="0">
    <tr>
      <td class="bg_tr" style="height:25px; line-height:25px;"><span style="float:left; padding-left:2px;">药品分类管理</span><span style="float:right;"><input id="Button1"
              type="button" value="添加" onclick="window.location.replace('DrugTypeAdd.aspx');" /></span></td>   
    </tr>
...
border="0">
    ...
    <tr>
       ...
       <td style="font-weight:bold" align="center" class="td_bg"  height="23">选择</td>
        ...
        <td style="font-weight:bold"  align="center" class="td_bg"  height="23">分类名称</td>
    ...
    <tr>
       ...
       <td align="center" class="td_bg" height="23"><input type="checkbox" value='<%#Eval("Dt_Id") %>' name="CheckMes" /></td>
        <td align="center" class="td_bg" height="23"><%#Container.ItemIndex + 1 + (currentPageIndex - 1) *  pageSize%></td>
       
        <td align="center" class="td_bg" height="23"><%#Eval("Dt_Name")%></td>
       
       <td align="center" class="td_bg" height="23"><a href='DrugTypeAdd.aspx?id=<%#Eval("Dt_Id")%>'>修改</a></td>
    </tr>
