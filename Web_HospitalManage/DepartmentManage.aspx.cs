...
public partial class DepartmentManage : System.Web.UI.Page
{
    ...
    public string strUrlPage = "DepartmentManage.aspx";//跳转的页
    ...
    private void Binds()
    {
        ...
        count = DepartmentBLL.CountNumber(strWhere);
        FenYe();
        RpView.DataSource = DepartmentBLL.PageSelectDepartment(pageSize, currentPageIndex, strWhere, "D_Id", "asc");
        RpView.DataBind();
    ...
    protected void BtnAllDel_Click(object sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
        {
            try
            {
                ...
                {
                    j++;
                    DepartmentBLL.DeleteDepartment(Convert.ToInt32(c));
                }
